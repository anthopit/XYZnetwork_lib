...
from CharVis.path import *

# Create a new transport network
G = pp.create_network_from_trailway("../../../data/Railway Data_JL.xlsx")
TN = tn.TransportNetwork(G, time_arguments=["dep_time", "arr_time"], nodes_weight_argument="lat", edges_weight_argument="train_max_speed")
...
map_eccentricity_analysis(TN, scale=5)
